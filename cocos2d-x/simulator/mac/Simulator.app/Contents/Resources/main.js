(function () {
    ...
    function boot () {
        ...
        var AssetOptions = {
            libraryPath: '/Users/zzf2019/Desktop/development/supportAstc/library/imports/',
            rawAssetsBase: '/Users/zzf2019/Desktop/development/supportAstc/',
        ...
        jsList = jsList.concat(window.__modular.srcs.map(function(s) {
            return s.replace('preview-scripts/', '/Users/zzf2019/Desktop/development/supportAstc/temp/quick-scripts/');
        }));
